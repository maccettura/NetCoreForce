...
public class JsonClient : IDisposable
{
    ...
    /// <summary>
    /// Submits a POST request for polymorphic objects using the polymorphic serializer
    /// </summary>
    /// <param name="inputObject"></param>
    /// <param name="uri"></param>
    /// <param name="customHeaders"></param>
    ...
    /// <typeparam name="T"></typeparam>
    /// <returns></returns>
    public async Task<T> HttpPostAsyncPolymorphic<T>(
        object inputObject,
        Uri uri,
        Dictionary<string, string> customHeaders = null,
        bool deserializeResponse = true,
        ...
        bool ignoreNulls = true)
    {
        string json = JsonSerializer.SerializePolymorphicForUpdate(inputObject, fieldsToNull: fieldsToNull, ignoreNulls: ignoreNulls);

        Debug.WriteLine("=== HttpPostAsyncPolymorphic JSON ===");
    ...
    /// <summary>
    /// Submits a PATCH request for polymorphic objects
    /// </summary>
    /// <param name="inputObject"></param>
    /// <param name="uri"></param>
    /// <param name="customHeaders"></param>
    ...
    /// <typeparam name="T"></typeparam>
    /// <returns></returns>
    public async Task<T> HttpPatchAsyncPolymorphic<T>(
        object inputObject,
        Uri uri,
        Dictionary<string, string> customHeaders = null,
        bool deserializeResponse = true,
